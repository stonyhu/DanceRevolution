...
[[Project]](https://stonyhu.github.io/dancerev/) [[Paper]](https://openreview.net/forum?id=xGZG2kS5bFk) [[Video]](https://pan.baidu.com/s/1rKFtrGWBG8BEjPQmDkJbJg?pwd=wnnn)
...
- We released the dance pose data and the corresponding audio data into [[Baidu Cloud]](https://pan.baidu.com/s/1_5GU9efw1PaOwnUKulQ-Kw?pwd=dgxv).
...
| ---------------------------------------- | :---------------------------------------------------------------------------------------: |
| **n_layers=1,seq_len=900,lambda_v=0.01** | Model_epoch5500 [[Baidu Cloud]](https://pan.baidu.com/s/1AhqdH5pQfiMN9kIRYNpiqg?pwd=fr62) |
